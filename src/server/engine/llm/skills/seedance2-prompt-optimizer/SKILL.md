---
name: seedance2-prompt-optimizer
description: "Seedance 2.0 提示词优化器(@图片N 绑定语法 / 八大要素 / 路径 A·B)"
---

# Seedance 2.0 Prompt Optimizer（sd2-pe）

> 官方 skill。把"分镜 + 锚点素材"翻译成符合 Seedance 2.0 实际语法的工程化视频提示词。
> 在 reel 里作为 `cinema-video-prompt` / `kinetic-video-prompt` 的 Seedance 2.0 升级规范。
